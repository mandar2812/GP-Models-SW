...
After running the workflow steps as outlined in section \ref{sec:workflow} above, we can understand the performance of the GP-AR and GP-ARX family of models on task of $Dst$ prediction in the following charts.
